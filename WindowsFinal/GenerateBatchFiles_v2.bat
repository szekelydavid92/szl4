...
echo %Location%\bin\javac -d ..\bin bottom_layer\*.java common\*.java proto\*.java view\*.java upper_layer\entity\*.java upper_layer\reactive\*.java upper_layer\wormhole\*.java upper_layer\*.java >> WindowsFinal\Compile.bat
